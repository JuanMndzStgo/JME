...
public class GuessNumberMidlet extends MIDlet 
    ...
    private String msgPrompt="Adivine el numero (entero)";
    
    
    public void startApp() {
    textbox=new TextBox("Adivine el numero", msgPrompt,60, TextField.PLAIN);
    ...
    private String checkNumber(String strNumberIn){
        ...
        if(numberIn==secretNumber){
            ...
            numTrial=0;
            secretNumber= rand.nextInt(100);
            return "Felicidades\n"+ "Lo conseguuiste en "+numTrialSaved+" Intentos";
        }
        if (numberIn>secretNumber){
